function modelingConvergence(varargin)
% CONVERGENCE  Analyze the convergence of the simulation carried out.
%
% Arguments:
...
MatlabSolution = computeMatlabSolution(sdivSet, nMode);
...
function Solution = computeMatlabSolution(sdivSet, nMode)
% COMPUTEMATLABSOLUTION  Compute the Matlab solutions.
%
% Arguments:
